#!/bin/bash
#SBATCH --job-name=nanochat-d24-1gpu-muono
...
# d24 MuonO experiments on a single H200.
# Same as run_h200_d24_muono.sh but 1 GPU — no torchrun, ~8x slower wall clock.
...
run_exp() {
    local NAME="$1"
    shift
    local TAG="${SERIES_NAME}_d24_1gpu_muono_${NAME}"
...
log "=================================================="
log "d24 1×H200 MuonO experiments complete!"
log "=================================================="
